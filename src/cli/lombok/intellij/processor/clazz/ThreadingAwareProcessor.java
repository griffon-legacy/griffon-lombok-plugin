 ...
 */
public class ThreadingAwareProcessor extends AbstractLombokClassProcessor implements ThreadingAwareConstants {
    ...
    protected boolean validateAnnotationOnRigthType(@NotNull PsiClass psiClass, @NotNull ProblemBuilder builder) {
        ...
        if (psiClass.isAnnotationType() || psiClass.isInterface() || psiClass.isEnum()) {
            builder.addError(ErrorMessages.canBeUsedOnClassOnly(ThreadingAware.class));
            result = false;
        }
        return result;
    }
