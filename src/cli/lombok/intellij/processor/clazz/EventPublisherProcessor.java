 ...
 */
public class EventPublisherProcessor extends AbstractLombokClassProcessor implements EventPublisherConstants {
    ...
    protected boolean validateAnnotationOnRigthType(@NotNull PsiClass psiClass, @NotNull ProblemBuilder builder) {
        ...
        if (psiClass.isAnnotationType() || psiClass.isInterface() || psiClass.isEnum()) {
            builder.addError(ErrorMessages.canBeUsedOnClassOnly(EventPublisher.class));
            result = false;
        }
        return result;
    }
