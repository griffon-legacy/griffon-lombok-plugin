 ...
 */
public class ResourcesAwareProcessor extends AbstractLombokClassProcessor implements ResourcesAwareConstants {
    ...
    protected boolean validateAnnotationOnRigthType(@NotNull PsiClass psiClass, @NotNull ProblemBuilder builder) {
        ...
        if (psiClass.isAnnotationType() || psiClass.isInterface() || psiClass.isEnum()) {
            builder.addError(ErrorMessages.canBeUsedOnClassOnly(ResourcesAware.class));
            result = false;
        }
        return result;
    }
