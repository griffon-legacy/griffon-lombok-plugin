 ...
 */
public class HandleVetoable extends EclipseAnnotationHandler<Vetoable> {
    @Override
    public void handle(final AnnotationValues<Vetoable> annotation, final Annotation source, final EclipseNode annotationNode) {
